...
<?php echo $form->create(null, array('action' => 'admin_index', 'class' => 'fieldset2')); ?>
	<?php echo $form->input('default_quota', array('label' => 'Default user quota', 'value' => $quota, 'after' => ' ' . $form->input('unit', array('options' => array('b' => 'Bytes', 'kb' => 'Kilobytes', 'mb' => 'Megabytes', 'gb' => 'Gigabytes'), 'value' => 'mb', 'div' => false, 'label' => false)))); ?>
